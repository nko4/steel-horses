...
~~~sh
# getting the code
git clone git@github.com:nko4/steel-horses.git && cd ./steel-horses/

# developing
npm install
npm start

# deploying (to http://steel-horses.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@steel-horses.2013.nodeknockout.com
ssh root@steel-horses.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@steel-horses.2013.nodeknockout.com
ssh -i ./id_deploy root@steel-horses.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/steel-horses" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
